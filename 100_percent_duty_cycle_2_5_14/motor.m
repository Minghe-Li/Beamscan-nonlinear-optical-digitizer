classdef motor < handle 
    ...
    properties (Constant, Hidden)
       ...
       TCUBESTEPPERDLL='Thorlabs.MotionControl.TCube.StepperMotorCLI.dll'
       TCUBESTEPPERCLASSNAME='Thorlabs.MotionControl.TCube.StepperMotorCLI.TCubeStepper'
            ...
            if ~h.isconnected
                switch(serialNo(1:2))
                    ...
                    otherwise % Serial number is not a PRM1Z8 or a K10CR1
                        h.deviceNET=Thorlabs.MotionControl.TCube.StepperMotorCLI.TCubeStepper.CreateTCubeStepper(serialNo);
        ...
        function loaddlls() % Load DLLs
            if ~exist(motor.DEVICEMANAGERCLASSNAME,'class')
                try   % Load in DLLs if not already loaded
                    ...
                    NET.addAssembly([motor.MOTORPATHDEFAULT,motor.TCUBESTEPPERDLL]);
