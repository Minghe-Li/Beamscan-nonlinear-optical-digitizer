...
AcqParameters.FilePath = 'D:\Changqin\20200812\Dishan_SHG\';  %If this path is not in purple, something is wrong!
...
AcqParameters.BufferSize = 2; % Units in gigabytes
...
AcqParameters.NumberOfImages =  100000;%*ManualLissajousSlowMirrorPhase; 100000
%% Channels To Acquire%%%%%%%%%
...
AcqParameters.FlipCountingPolarity = 1;
%Channel A     
CaptureChannelA = 0;
ChannelACount = 0;     ChannelAThreshold = -3;     ChannelALambda = 0; %0.5
...
AcqParameters.NumChannelsToDisplay = 1;
    ...
    AcqParameters.FirstChannelToDisplay = 'B-Count-Pol1'; % A-Count-Pol1,B-Avg-Pol2, etc.
    AcqParameters.SecondChannelToDisplay = 'A-count-Pol1'; 
...
AcqParameters.CheckForClippingEveryNBuffers = 1000;
...
OverrideMeasuredGalvoResMirrorPhase = 1;           ManualGalvoResMirrorPhase = 2040;%2020*1; %-2290 %-2550 %-2589
...
AcqParameters.LissaJous = 0; %Indicates that this was a LissaJous scanned image
    ...
    AcqParameters.ShotsPerFastMirrorPeriod = 4535*1*2; %2626
    AcqParameters.ShotsPerSlowMirrorPeriod = 1039878*1*2; %2965; 2964
...
OverrideMeasuredLissajousMirrorPhase = 1;  ManualLissajousFastMirrorPhase = 2000;  ManualLissajousSlowMirrorPhase = 110000;
