...
AcqParameters.FilePath = 'F:\James\NOSE\2018\01-16-18\collagen\Snapshot\CalibrateDepol\MuellerTensorApproach\20x\';  %If this path is not in purple, something is wrong!
...
Auto_Rotation = 1;
Rotation_Stage_Port = 'COM6';
Rotation_Stage_Position = 1; %QWP; inner loop
Rotation_Start_Point = 0; 
Rotation_End_Point = 90; 
Rotation_Inteval = 22.5;
Pause_Time = 12.5; %In sec;

Rotation_Stage_Port2 = 'COM6'; %Polarizer; outer loop
Rotation_Stage_Position2 = 2;
Rotation_Start_Point2 = 0; 
Rotation_End_Point2 = 135; 
...
AcqParameters.NumberOfFramesPerImage =  4;
...
OverrideMeasuredGalvoResMirrorPhase = 1;           ManualGalvoResMirrorPhase = 1580; %-2290 %-2550 %-2589
