...
AcqParameters.FilePath = 'D:\James\NOSE\2019\12-05-19\blank_EOM_Amp200mV_0degPhase_85mW\';  %If this path is not in purple, something is wrong!
...
AcqParameters.NumberOfFramesPerImage =  16*10;
...
AcqParameters.ShotsPerMirrorPeriodGalvoRes = 4530*2*1;%5112*2*4; % Same value as in resonant mirror control box software, (off by factor of 2)
...
%            break
       ...
       for j = Rotation_Start_Point2:Rotation_Inteval2:Rotation_End_Point2
            ...
            for i = inner_rotate
                ...
                if Deg >= 100
                    AcqParameters.FilePath = strcat(Original_FilePath,Inner_folder_name,num2str(Deg),'Degree');
                elseif Deg >=10
                    AcqParameters.FilePath = strcat(Original_FilePath,Inner_folder_name,'0',num2str(Deg),'Degree');
                else 
                    AcqParameters.FilePath = strcat(Original_FilePath,Inner_folder_name,'00',num2str(Deg),'Degree');
                end
...
totalImageTime = etime(datevec(timeFinish),datevec(timeStart))
