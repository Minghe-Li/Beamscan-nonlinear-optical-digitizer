...
AcqParameters.FilePath = 'F:\GeigerLab\Mona\2015.2.22\20131111a\FOV3\lowHumidity\';  %If this path is not in purple, something is wrong!
...
AcqParameters.FlipCountingPolarity = true;
...
%Channel C    
CaptureChannelC =0;
ChannelCCount =1;      ChannelCThreshold = -3;     ChannelCLambda = 0;
ChannelCAvg = 0;       ChannelCHybridAvgCount = 0;

%Channel D 
CaptureChannelD =0;
ChannelDCount = 1;     ChannelDThreshold = -3;       ChannelDLambda = 0;
...
AcqParameters.NumChannelsToDisplay =1;
    ...
    AcqParameters.FirstChannelToDisplay = 'a-avg-pol1'; % a-count-Pol1,b-avg-pol1, etc.
    ...
    InvChanA = 0;       InvChanB = 0;       InvChanC = 1;       InvChanD =1;
...
AcqParameters.ShotsPerMirrorPeriodGalvoRes = 5113*2; % Same value as in resonant mirror control box software, (off by factor of 2)
...
%2) Saturating the Alazar ch8annel input range
...
OverrideMeasuredGalvoResMirrorPhase = 1;           ManualGalvoResMirrorPhase = 3180 ; %-2550 %-2589
...
ComPort = 'COM9'; % 'COM4', 'COM3', etc, depends on which USB plug you have it in.
...
AcqParameters.LissaJous = 0; %Indicates that this was a LissaJous scanned image
    ...
    AcqParameters.ShotsPerFastMirrorPeriod = 2630*2*1; %2626
    AcqParameters.ShotsPerSlowMirrorPeriod = 2965*2*1; %2965
...
%for absent signal or weak signal, the algorithm chooses to not update phase instead of providing an uncertain measurement. Measuring
%phase from a portion of a frame acquisition, such as canceling an acquisition early, may trigger this scenario.
OverrideMeasuredLissajousMirrorPhase = 1;  ManualLissajousFastMirrorPhase = 445*1;  ManualLissajousSlowMirrorPhase = 650*1;

%last known working values when using the ITHACO filter set
%OverrideMeasuredLissajousMirrorPhase = 1;  ManualLissajousFastMirrorPhase = 424;  ManualLissajousSlowMirrorPhase = 623;
%without ITHACO
%OverrideMeasuredLissajousMirrorPhase = 1;  ManualLissajousFastMirrorPhase = 434;  ManualLissajousSlowMirrorPhase = 3650;
